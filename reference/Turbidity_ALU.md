...
and/or thresholds for aquatic life use (ALU). For more information, see
...
``` r
Turbidity_ALU(Chem_table, DU_table, Criteria_table)
```
...
A list of two dataframes. The first contains analyzed turbidity data
